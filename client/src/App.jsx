...
import { 
  ...
  ChevronDown, FileText, HelpCircle, AlertTriangle, Navigation, PenTool, Mail, Coffee, Home, Info, Grid
} from 'lucide-react';
    ...
    <div className="container mx-auto px-6">
      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid md:grid-cols-3 gap-10">
        {[
          ...
          { icon: Truck, title: "Secure Courier", desc: "White-glove delivery for sensitive legal & real estate documents." }
        ].map((s, i) => (
