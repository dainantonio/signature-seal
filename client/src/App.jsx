...
import { 
  Award, Menu, X, Check, Car, ShieldCheck, 
  MessageSquare, Send, Loader2, Lock, Calendar, 
  Clock, LogOut, Trash2, Download, CreditCard,
  ChevronDown, FileText, Navigation, PenTool, Mail, Coffee, Home, Briefcase, Info, QrCode, Grid
} from 'lucide-react';
...
const BackToTop = () => {
  ...
  return (
    <button
      ...
      title="Back to Top"
    >
      <Clock size={24} className="rotate-180" /> {/* Using Clock as arrow sub temporarily to fix icon crash risk */}
    </button>
  );
};
...
function App() {
  ...
  return (
    <div className="font-sans min-h-screen bg-white">
      ...
      {/* Floating Button: Hide if Booking Open (to prevent overlap) */}
