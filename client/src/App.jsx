...
// Floating Mobile Action Button (Always Visible unless booking modal is open)
...
const FAQ = () => {
  ...
  const faqs = [
    ...
    { q: "How does pricing work?", a: "We charge a standard Travel Fee (starting at $40) to come to you. The state-regulated Notary Fee ($10 per stamp in WV) is separate and collected at the appointment. I-9 services are flat rates." },
...
function App() {
  ...
  return (
    <div className="font-sans min-h-screen bg-white">
      ...
      {/* Floating Button: Hide if Booking Open to avoid overlap. SHOW for admin so they can test. */}
