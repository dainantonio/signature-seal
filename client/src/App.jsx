        ...
        {success ? (
          ...
          <>
            ...
            <div className="p-8 overflow-y-auto bg-gray-50/30">
              ...
              {step === 3 && (
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg space-y-6">
                  <div className="flex justify-between items-center"><span className="text-gray-400 font-medium">Service</span><span className="font-bold text-brand-navy-dark text-lg">{formData.service}</span></div>
                  <div className="flex justify-between items-center"><span className="text-gray-400 font-medium">When</span><span className="font-bold text-brand-navy-dark text-lg">{formData.date} at {formData.time}</span></div>
                  <div className="h-px bg-gray-100 w-full"></div>
                  <div className="flex justify-between items-center"><span className="text-gray-400 font-medium">For</span><span className="font-bold text-brand-navy-dark">{formData.name}</span></div>
                  <div className="flex justify-between items-start"><span className="text-gray-400 font-medium">Where</span><span className="font-bold text-brand-navy-dark text-right max-w-[200px]">{formData.address}</span></div>
                </div>
              )}
            </div>
            ...
            <div className="p-6 border-t border-gray-100 flex justify-between bg-white">
              ...
              >
                {isSubmitting ? <Loader2 className="animate-spin" /> : step === 3 ? 'Confirm Booking' : 'Continue'} <ArrowRight size={18} />
              </button>
            </div>
          </>
        )}
